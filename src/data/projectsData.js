const projectArray = [
  ...
  },
  {
    ...
    projectDesc:
      "I created this project as solution to one of my personal frustrations of trying to remember tv shows or movie names. Built using vanilla Javascript, it connects both the IMDB and Jikan API to combine movies, tv shows and animes all into one place. Save them to a list for later viewing.",
  ...
  },
  {
    ...
    projectDesc:
      "A tenzies game inspired by Scrimba's Beginner React course. Expanded upon and implemented additional functionalities and changed aesthetics of the website to further synthesise my learning of React. Additional functionalities includes timer, best recorded time and visual/animation updates.",
